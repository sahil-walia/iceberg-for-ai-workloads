"""EXP-13: controlled Apache Iceberg small-file compaction benchmark.
...
def configure_java_17() -> None:
    ...
    if not (17 <= major < 25):
        raise RuntimeError(
            "EXP-13 requires Java 17 through 24 (Java 17 recommended). "
...
def write_outputs(summary: dict[str, Any], timestamp: str) -> list[Path]:
    ...
    stem = RESULTS_DIR / f"iceberg_compaction_spark4_{timestamp}"
...
def run_experiment(args: argparse.Namespace) -> dict[str, Any]:
    ...
    if args.warehouse:
        ...
        temporary = tempfile.TemporaryDirectory(prefix="iceberg-exp13-")
    ...
    try:
        ...
        summary = {
            "experiment": "EXP-13: Apache Iceberg small-file compaction",
